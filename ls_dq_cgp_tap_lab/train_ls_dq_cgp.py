...
def main():
    parser = argparse.ArgumentParser(description="Train LS-DQ-CGP + QAP on Soccer-GMR")
    parser.add_argument("--output", default="outputs/ls_dq_cgp_tap_seed2023", help="Output directory")
    ...
    opt.component_variant = "ls_dq_cgp_tap_exist" if args.use_exist_head else "ls_dq_cgp_tap"

    experiment_meta = {
        "variant": opt.component_variant,
        "seed": args.seed,
        "model": "LateSemantic_QAP_MomentDETR",
