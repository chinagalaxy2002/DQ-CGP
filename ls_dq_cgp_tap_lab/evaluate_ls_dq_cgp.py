...
from ls_dq_cgp_tap_lab.ls_dq_cgp_model import LSDQCGPModel
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate LS-DQ-CGP + QAP")
    ...
    result_record = {
        "variant": "ls_dq_cgp_tap_exist" if has_exist_head else "ls_dq_cgp_tap",
