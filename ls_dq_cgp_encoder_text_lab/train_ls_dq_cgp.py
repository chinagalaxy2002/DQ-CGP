"""Training script for Encoder-Text Late-Semantic DQ-CGP."""
...
def main():
    parser = argparse.ArgumentParser(description="Train Encoder-Text LS-DQ-CGP on Soccer-GMR")
    parser.add_argument("--output", default="outputs/encoder_text_ls_dq_cgp_seed2023", help="Output directory")
    ...
    experiment_meta = {
        ...
        "seed": args.seed,
        "model": "EncoderTextLateSemantic_MomentDETR",
        "encoder_text_pool": "masked_mean",
        "semantic_anchor": "pre_encoder_static_mean",
    ...
    logger.info(
        "Starting Encoder-Text LS-DQ-CGP training with exist_head=%s, "
        "semantic_mask=%s, seed=%d, total epochs=%d...",
        args.use_exist_head,
        opt.query_cgp_use_semantic_mask,
        args.seed,
        args.epochs,
    )
