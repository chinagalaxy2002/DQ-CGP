"""Evaluate Token-Selective LS-DQ-CGP and its counterfactual modes."""
...
from ls_dq_cgp_token_lab.ls_dq_cgp_model import LSDQCGPModel
...
def main():
    ...
    counterfactual.add_argument(
        ...
        action="store_true",
        help=(
            "Replace occurrence-conditioned local semantic with global static "
    ...
    result_record = {
        "variant": "token_ls_dq_cgp_exist" if has_exist_head else "token_ls_dq_cgp",
    ...
    print("\n" + "=" * 60)
    print(f"Token LS-DQ-CGP Evaluation Summary [{args.split.upper()}] (Mode: {mode_name}, Exist Head: {has_exist_head})")
    print("=" * 60)
